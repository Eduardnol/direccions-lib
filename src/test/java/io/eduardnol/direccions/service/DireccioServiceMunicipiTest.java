...
class DireccioServiceMunicipiTest {
    ...
    void getAllMunicipi_ShouldReturnListOfMunicipalities() {
        // Given
        ComunitatAutonomaEntity ca = ComunitatAutonomaEntity.builder()
        ...
        MunicipiEntity municipi1 = MunicipiEntity.builder()
                .idMunicipi(1L)
                .codi("08001")
                .nom("Barcelona")
                .provincia(provincia)
        ...
        MunicipiEntity municipi2 = MunicipiEntity.builder()
                .idMunicipi(2L)
                .codi("08002")
                .nom("Badalona")
                .provincia(provincia)
